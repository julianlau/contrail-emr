...
{	
	...
	implements Mapper<LongWritable, Text, Text, Text> 
	{
		...
		throws IOException 
		{
			...
			if (mergedir != null)
			{
				...
				reporter.incrCounter("Contrail", "mergenodes", 1);
			}
			else
			{
	...
	implements Reducer<Text, Text, Text, Text> 
	{
				...
				throws IOException 
		{
			...
			{
				reporter.incrCounter("Contrail", "needscompress", 1);
			}
	...
	{ 
		...
		FileSystem.get(new java.net.URI(outputPath), conf).delete(new Path(outputPath), true);
	...
	{
		String inputPath  = "/Users/mschatz/try/mark1/";
		String outputPath = "/users/mschatz/try/merge1/";
		ContrailConfig.K = 21;
